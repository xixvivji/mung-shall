...
export function ApplicationStep({ isEditable, onSubmitSuccess, adoptionId }: Props) {
  ...
  useEffect(() => {
    ...
    console.debug("[MyPage ApplicationStep] useEffect [getAdoptionApplication] running", {
    ...
    if (lastFetchedIdRef.current === safeAdoptionId) {
      ...
      console.debug("[MyPage ApplicationStep] skip duplicate getAdoptionApplication", {
    ...
    console.debug("[MyPage ApplicationStep] getAdoptionApplication (API Call)", {
